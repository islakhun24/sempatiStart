...
public class LaporanTransaksiDetailActivity extends AppCompatActivity {

    ActivityLaporanTransaksiDetailBinding v;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        v = ActivityLaporanTransaksiDetailBinding.inflate(getLayoutInflater());
...
//        Log.e(TAG, "getTransaksi: "+getTanggalAwal()+"-"+getTanggalAkhir() );
        ...
        adapter = new TransaksiLaporanDetailAdapter(this, listTransaksi);
