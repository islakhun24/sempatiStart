...
import sempati.star.app.activity.LaporanManifestDetailActivity;
...
public class TransaksiManifestAdapter extends RecyclerView.Adapter<TransaksiManifestAdapter.ViewHolder> {

    private Context context;
    private List<TransaksiModel> list;
    private TransaksiRawBinding v;

    public TransaksiManifestAdapter(Context context, List<TransaksiModel> list){
...
//                        .putExtra("from", "fame")
//                );
                context.startActivity(new Intent(context, LaporanManifestDetailActivity.class)
